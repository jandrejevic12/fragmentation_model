...
for i,ax in enumerate(axes):
    ...
    ax.plot(x/s[-1], scaling_fun(x/s[-1],a), linestyle='dashed', color='k', alpha=0.8, lw=4, label='$\\phi_{ana}$')
    ...
    ax2.plot(x/s[-1], scaling_fun(x/s[-1],a), linestyle='dashed', color='k', alpha=0.8, lw=4, label='$\\phi_{ana}$')
...
ax.plot(tt, mean_fun(tt,a), linestyle='dashed', color='k', alpha=0.8, lw=4, label='$s_{ana}$')
ax.set_yscale('log')
ax.set_xscale('log')
#ax.set_xlim(-10,210)
